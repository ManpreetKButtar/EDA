...
import os
os.getcwd() # to chcek the current working directory
# Read data into Python
education = pd.read_csv("Documents/Python/EDA/education.csv")
...
cars = pd.read_csv("Documents/Python/EDA/Cars.csv")
